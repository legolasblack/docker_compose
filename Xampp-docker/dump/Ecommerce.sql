...
INSERT INTO `compra` VALUES (1,1,1,0.00,250.00,'2024-02-19',1,'2024-02-19 22:54:27','2024-02-19 22:54:27');
...
INSERT INTO `producto` VALUES (1,'pez betta',NULL,250.00,2,1,'2024-02-19 22:54:05','2024-02-19 22:54:05');
...
CREATE TABLE `productos_favoritos` (
  ...
  CONSTRAINT `productos_favoritos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`),
  CONSTRAINT `productos_favoritos_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`)
...
INSERT INTO `usuario` VALUES (1,'Diego','legolas_black_ds','12345',1,'2024-02-19 22:54:05','2024-02-19 22:54:05');
...
-- Dump completed on 2024-02-19 17:12:34
